...
The model picker exposes GPT-5.6 as an expandable family (Sol / Terra / Luna), and the cost-based credit system prices each tier on real usage. In short: **GPT-5.6 built the factory, and now GPT-5.6 runs the factory** — every app a user creates with Launch's Builder profile is generated by GPT-5.6 Terra.
